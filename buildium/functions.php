...
add_image_size( 'gallery-size-home', 574, 417 );
...
function doc_init() {
	$labels = array(
		'name'               => _x( 'Documents', 'post type general name', 'integrity' ),
		'singular_name'      => _x( 'Documents', 'post type singular name', 'integrity' ),
		'menu_name'          => _x( 'Documents', 'admin menu', 'integrity' ),
		'name_admin_bar'     => _x( 'Documents', 'add new on admin bar', 'integrity' ),
		'add_new'            => _x( 'Add New', 'products', 'integrity' ),
		'add_new_item'       => __( 'Add New Documents', 'integrity' ),
		'new_item'           => __( 'New Documents', 'integrity' ),
		'edit_item'          => __( 'Edit Documents', 'integrity' ),
		'view_item'          => __( 'View Documents', 'integrity' ),
		'all_items'          => __( 'All Documents', 'integrity' ),
		'search_items'       => __( 'Search Documents', 'integrity' ),
		'parent_item_colon'  => __( 'Parent Documents:', 'integrity' ),
		'not_found'          => __( 'No Documents found.', 'integrity' ),
		'not_found_in_trash' => __( 'No Documents found in Trash.', 'integrity' )
	);
