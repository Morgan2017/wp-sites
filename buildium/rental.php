...
get_header('pages');?>
    ...
    <div class="container rentalListing">
        <div class="row">
			<iframe src="https://DE.managebuilding.com/Resident/PublicPages/ApartmentSearchFrame.aspx" width="1024px" height="1200px" scrolling="no" frameBorder="0"></iframe>
        </div>
    </div>
